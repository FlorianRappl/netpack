...
The netpack project ultimately tries to provide a bundler for web projects using C#/.NET.

## Code License

This is an open source project falling under the [MIT License](../LICENSE). By using, distributing, or contributing to this project, you accept and agree that all code within the netpack project and its libraries are licensed under MIT license.
