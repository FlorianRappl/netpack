...
Covered in full in [Bundle analyzer](./analyzer.md) — the interactive
graph explorer, the dependency vulnerability audit, and the optimization
recommendations that flag where your chunks could be split more efficiently.
